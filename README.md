...
- [bug-solver](https://github.com/RJLfoever/bug-solver) - Given a bug phenomenon (error/log/symptom), searches the Feishu (Lark) Bitable bug-knowledge base and combines historical root causes from past bug-fix commits to hypothesize the most likely cause and solution, outputting a structured diagnosis report.
- [bug-summary](https://github.com/RJLfoever/bug-summary) - Daily Git commit capture: classifies commits into feature development vs bug fixes and records structured phenomenon / root cause / solution insights for bug-fix commits into a Feishu (Lark) Bitable knowledge base that both humans and agents can read and search.
